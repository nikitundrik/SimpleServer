...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SimpleServer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SimpleServer", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SimpleServer";
		app.meta["name"] = "SimpleServer";
